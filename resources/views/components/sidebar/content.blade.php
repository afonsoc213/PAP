...
>
    ...
    >
        <x-slot name="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard-check flex-shrink-0 w-6 h-6" viewBox="0 0 16 16" aria-hidden="true">
    ...
    <x-sidebar.link
        title="Def. do Inventário"
        href="{{ route('DefInventario') }}" 
        :isActive="request()->routeIs('DefInventario')"
    >
        <x-slot name="icon">
